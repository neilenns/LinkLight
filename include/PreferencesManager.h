...
public:
  ...
  unsigned int getAtStationThreshold() const { return atStationThreshold; }
  ...
  void setAtStationThreshold(unsigned int value) { atStationThreshold = value; }
...
private:
  ...
  unsigned int atStationThreshold;  // At-station threshold in seconds
